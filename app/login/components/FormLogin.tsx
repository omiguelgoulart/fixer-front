...
const [showPassword, setShowPassword] = useState(false);
  ...
  return (
    <div className="w-full md:w-1/2 bg-white flex justify-center items-center min-h-[50vh] md:min-h-screen p-8 sm:p-12">
      <div className="w-full max-w-md space-y-6">
        <h2 className="text-2xl sm:text-3xl font-semibold text-gray-800 text-center">Login</h2>
  ...
  <div className="flex items-center justify-between mb-1.5">
    ...
    <Link href="/esqueci-senha" className="text-sm text-blue-500 hover:underline">Esqueceu a Senha?</Link>
  </div>
